...
- [TWZRD Agent Intel](https://intel.twzrd.xyz) - Trust scoring and signed receipts for Solana AI agent wallets. Verify agent identity before x402 micropayments. Free: score_agent, preflight_check. Paid: get_trust_receipt (HTTP 402, <$0.01 USDC).
