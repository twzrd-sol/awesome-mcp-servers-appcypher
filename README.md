...
- [TWZRD Agent Intel](https://intel.twzrd.xyz) - Trust scoring for x402 agents on Solana. Free preflight check + paid signed trust receipt via USDC micropayment (<1s settlement). No install required — remote Streamable-HTTP at `https://intel.twzrd.xyz/mcp`.
