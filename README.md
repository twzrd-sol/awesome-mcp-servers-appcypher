...
- <img src="https://intel.twzrd.xyz/favicon.ico" height="14"/> [TWZRD Agent Intel](https://intel.twzrd.xyz/mcp) - Trust scoring and identity verification for AI agent wallets on Solana. Free tools: `score_agent(wallet)`, `preflight_check(wallet)`. Paid (x402 micropayment): `get_trust_receipt(wallet)`
