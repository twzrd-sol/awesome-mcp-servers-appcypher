...
- <img src="https://intel.twzrd.xyz/favicon.ico" height="14"/> [TWZRD Agent Intel](https://intel.twzrd.xyz) - Trust scoring and x402 micropayment verification MCP server for AI agents on Solana. Free tools: on-chain wallet trust scoring. Paid: signed trust receipts via HTTP 402 + USDC micropayment (<$0.01). Zero-install: `https://intel.twzrd.xyz/mcp` (Streamable HTTP).
