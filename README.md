...
- 🔮 [WZRD Velocity](https://github.com/twzrd-sol/wzrd-final) - AI model velocity oracle with 26 MCP tools. Real-time adoption momentum for 100+ models across HuggingFace, GitHub, OpenRouter, and ArtificialAnalysis. Streamable HTTP at `app.twzrd.xyz/api/mcp`. Agents pick trending models and earn on Solana.
