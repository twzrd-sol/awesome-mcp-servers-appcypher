...
- [TWZRD Agent Intel](https://intel.twzrd.xyz) - Trust scoring and x402 micropayment verification for AI agents on Solana. Resolve agent identity, score trust, and verify USDC payment receipts. Free tier included; paid tools use HTTP 402 per-call billing.
