...
- 🔮 [WZRD Velocity](https://github.com/twzrd-sol/wzrd-velocity) - AI model velocity oracle with 26 MCP tools. Real-time adoption momentum for 100+ models across HuggingFace, GitHub, OpenRouter, and ArtificialAnalysis. Streamable HTTP at [app.twzrd.xyz/api/mcp](https://app.twzrd.xyz/api/mcp).
