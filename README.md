...
- [twzrd-sol/twzrd-agent-intel](https://github.com/twzrd-sol/wzrd-final) - Solana agent trust scoring via x402 micropayments. Free preflight + paid trust ($0.05) + market intel ($0.03). MCP at https://intel.twzrd.xyz/mcp
