...
- <img src="https://intel.twzrd.xyz/favicon.ico" height="14"/> [TWZRD Agent Intel](https://intel.twzrd.xyz) - Solana-native MCP server for agent trust scoring and identity verification in multi-agent systems. Score any wallet, verify agent identity, and get signed receipts for audit trails via HTTP 402 + USDC micropayments.
